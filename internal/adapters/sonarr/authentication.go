...
// HostConfigResource represents Sonarr host configuration (includes authentication)
...
func (a *Adapter) applyAuthentication(ctx context.Context, c *httpClient, ir *irv1.AuthenticationIR) error {
	...
	// Map method string to Sonarr API values
...
// mapAuthMethod maps our method string to Sonarr API values
...
// mapAuthRequired maps our authenticationRequired string to Sonarr API values
